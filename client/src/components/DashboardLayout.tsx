...
function DashboardLayoutContent({
 ...
 <div className="mb-2 flex w-full items-center gap-3 rounded-lg px-3 py-2 text-xs text-muted-foreground group-data-[collapsible=icon]:justify-center" aria-label="Black AMOLED theme" title="Black AMOLED"><MoonStar className="h-4 w-4 text-primary" /><span className="group-data-[collapsible=icon]:hidden">Black AMOLED</span></div>
 <DropdownMenu>
