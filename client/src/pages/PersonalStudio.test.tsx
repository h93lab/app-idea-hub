...
const mocks = vi.hoisted(() => ({
  personalGet: vi.fn(), personalDecision: vi.fn(), personalExport: vi.fn(), personalUpdate: vi.fn(), personalReset: vi.fn(), personalGenerate: vi.fn(), validationGenerate: vi.fn(), monitorList: vi.fn(), ratingHistory: vi.fn(), monitorCreate: vi.fn(), monitorCheck: vi.fn(), monitorSchedule: vi.fn(), monitorSetEnabled: vi.fn(), monitorRemoveSchedule: vi.fn(), monitorRemove: vi.fn(), keywordList: vi.fn(), marketingArchives: vi.fn(), keywordExplore: vi.fn(), marketingDescription: vi.fn(), marketingArchiveDelete: vi.fn(), marketingArchiveUpdate: vi.fn(),
}));
