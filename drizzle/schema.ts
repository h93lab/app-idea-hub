...
export const personalWorkspaces = mysqlTable("personalWorkspaces", {
  ...
  reviewIntelligence: json("reviewIntelligence").$type<Record<string, any>>().notNull(),
  opportunityScoring: json("opportunityScoring").$type<Record<string, any>>().notNull(),
  competitorGapMatrix: json("competitorGapMatrix").$type<Record<string, any>>().notNull(),
  asoRankTracker: json("asoRankTracker").$type<Record<string, any>>().notNull(),
  monetizationLab: json("monetizationLab").$type<Record<string, any>>().notNull(),
  validationExperiments: json("validationExperiments").$type<Record<string, any>>().notNull(),
  buildEstimator: json("buildEstimator").$type<Record<string, any>>().notNull(),
  claudeCodeMission: json("claudeCodeMission").$type<Record<string, any>>().notNull(),
  qaLab: json("qaLab").$type<Record<string, any>>().notNull(),
  launchReadiness: json("launchReadiness").$type<Record<string, any>>().notNull(),
  trendRadar: json("trendRadar").$type<Record<string, any>>().notNull(),
  evidenceVault: json("evidenceVault").$type<Record<string, any>>().notNull(),
  ideaPortfolio: json("ideaPortfolio").$type<Record<string, any>>().notNull(),
  postLaunchLearning: json("postLaunchLearning").$type<Record<string, any>>().notNull(),
  updatedAt: timestamp("updatedAt").defaultNow().onUpdateNow().notNull(),
